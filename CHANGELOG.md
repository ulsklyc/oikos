...
- **Recurring calendar events are easier to recognise before opening them.** A small, accessible
  ...
  supplied explicitly by the calendar form and follows its active timed or all-day field. Tasks
  keep their separate due-date explanation, and recurrence storage and sync behaviour are unchanged.
